export const Config = {
  ...
  USER_NOTIFICATION_SUBSCRIPTION_NAME: process.env.USER_NOTIFICATION_SUBSCRIPTION_NAME,
  DISCOUNT_NOTIFICATION_SUBSCRIPTION_NAME: process.env.DISCOUNT_NOTIFICATION_SUBSCRIPTION_NAME,
