export const Config = {
  ...
  // PUBSUB
  APPLY_WELCOME_DISCOUNT_SUBSCRIPTION_NAME: process.env.APPLY_WELCOME_DISCOUNT_SUBSCRIPTION_NAME,
  WELCOME_NOTIFICATION_SUBSCRIPTION_NAME: process.env.WELCOME_NOTIFICATION_SUBSCRIPTION_NAME,
  CHANGED_DISCOUNT_NOTIFICATION_SUBSCRIPTION_NAME: process.env.CHANGED_DISCOUNT_NOTIFICATION_SUBSCRIPTION_NAME,
